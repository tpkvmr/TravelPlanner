...
namespace TravelPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20260116131442_IgnoreMetadataInTrip")]
    partial class IgnoreMetadataInTrip
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TravelPlanner.Core.Entities.AnalyticsEvent", b =>
                {
                    ...
                    b.HasIndex("EventTime", "EventName");
            ...
            modelBuilder.Entity("TravelPlanner.Core.Entities.Trip", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("SuitableSeasons")
                        .IsRequired()
                        .HasColumnType("TEXT");
